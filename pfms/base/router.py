...
def helloRouter_create(
    ...
    if tags is None:
        tags = ["pfms environmental detail"]
    ...
    class SysInfoModel(BaseModel):
        ...
        inet: str = Field(
            socket.gethostbyname(socket.gethostname()), title="Local IP address"
        )
    ...
    @router.get("/about/", tags=tags, response_model=AboutModel)
